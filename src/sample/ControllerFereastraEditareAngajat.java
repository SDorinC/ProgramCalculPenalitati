...
public class ControllerFereastraEditareAngajat {
    ...
    public void initialize() {
        ...
        textField1.focusedProperty().addListener(new ChangeListener<Boolean>() {
            ...
            public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
                if (newValue) {
                    label.setText("Editati detalii angajat");
    ...
    public Angajati procesare() {
        ...
        if (text1.isEmpty() && text2.isEmpty() && text3.isEmpty() && text4.isEmpty() && text5.isEmpty()) {
            label.setText("Nu a fost facuta nici o modificare");
    ...
    public void eroare() {
        label.setText("Suma restanta este mai mica decat totalul platilor");
        label.setTextFill(Color.RED);
        textField5.clear();
    }

    public void eroareData() {
        label.setText("Exista plati inregistrate inainte de data deciziei");
        label.setTextFill(Color.RED);
        textField4.clear();
    }
}
